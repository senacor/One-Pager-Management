            ...
            <div className="space-y-5 max-w-2xl">
                <div>
                    <input
                        ...
                        className={`block w-full p-4 border-2 rounded-lg text-base bg-gray-50 transition-all duration-300 focus:outline-none focus:bg-white ${errors.some(e => e.includes('fullName'))
                ...
                <div>
                    <select
                        ...
                        className={`block w-full p-4 border-2 rounded-lg text-base bg-gray-50 transition-all duration-300 focus:outline-none focus:bg-white ${errors.some(e => e.includes('position'))
                                ? 'border-red-300 focus:border-red-500'
                                : 'border-gray-200 focus:border-brand-blue'
                            }`}
                    >
