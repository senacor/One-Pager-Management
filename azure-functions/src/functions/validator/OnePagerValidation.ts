import { EmployeeID, OnePager, OnePagerRepository, ValidationError, ValidationReporter } from "./DomainTypes";

type ValidationRule = (onePager: OnePager | undefined) => Promise<ValidationError[]>;
